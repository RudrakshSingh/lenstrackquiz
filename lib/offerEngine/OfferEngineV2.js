...
export class OfferEngineV2 {
  ...
  /**
   * Check if rule is applicable (V2 Final - supports frameBrands array)
   */
  ...
  async calculate(input) {
    ...
    // Step 3: Execute handlers in priority order (V2 Final flow)
    const cart = { frame, lens, customerCategory: input.customerCategory };
